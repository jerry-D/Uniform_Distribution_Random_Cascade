...
The second function of the bin microcontroller is to report,  via Controller Area Network (CAN)  bus, the current count to the master controller when queried by it in a round-robin fashion.
